    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if plc_str.startswith("while "):
                ...
                return await _run_while_loop(func, plc_str, timeout, case, test_run_result, args, kwargs)
...
async def _run_while_loop(func, plc_str, timeout, case: Case, test_run_result, args, kwargs):
    """处理 while 循环逻辑"""
    ...
    while True:
        ...
        if Asserts.assert_response(result, case, test_run_result):  # 如果断言成功，退出循环
            break
