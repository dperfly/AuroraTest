...
if __name__ == "__main__":
                ...
                "logs": [
                    {
                        "time": "14:30:05.456",
                        "level": "error",
                        "message": "断言失败: 响应状态码等于200 (实际: 401)"
                    }
                ],
                "request": {
                    "userId": 12345
    ...
    # 生成报告
    generator = CompactHTMLTestReportGenerator(test_data)

    # 保存报告到文件
    generator.save_report("../compact_api_test_report.html")
